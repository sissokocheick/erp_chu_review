...
class NumeroGenerator:
    ...
    @staticmethod
    def generer_numero_demande(service, entreprise):
        """
        ✅ CORRECTION : paramètre `service` supprimé (jamais utilisé).
        Gardé pour compatibilité avec les appelants existants.
        """
        from ..services.compteur_service import CompteurDocumentService
        return CompteurDocumentService.generer_numero_demande(entreprise)
