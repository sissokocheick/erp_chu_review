...
TYPE_DOCS = [
    ...
    ('BDM2', 'Bon de Demande (secondaire)'),
...
@verifier_permission('accounts.menu_param_admin', 'accounts.menu_parametres', 'accounts.menu_parametres_doc')
...
def _handle_get(request, hopital, configs):
    ...
    context = {
        ...
        'hopital': hopital,
        'afficher_logo': getattr(hopital, 'afficher_logo', True),
        'afficher_cachet': getattr(hopital, 'afficher_cachet', True),
        'afficher_cc': getattr(hopital, 'afficher_cc', True),
        'afficher_ifu': getattr(hopital, 'afficher_ifu', True),
        'afficher_rccm': getattr(hopital, 'afficher_rccm', True),
        'afficher_telephone': getattr(hopital, 'afficher_telephone', True),
        'afficher_republique': getattr(hopital, 'afficher_republique', True),
        'afficher_devise': getattr(hopital, 'afficher_devise', True),
        'afficher_direction': getattr(hopital, 'afficher_direction', True),
        'afficher_sous_direction': getattr(hopital, 'afficher_sous_direction', True),
        'afficher_service': getattr(hopital, 'afficher_service', True),
...
def _handle_post(request, hopital, configs):
    ...
    if not user.is_superuser and not (
        ...
        return redirect('core:config_documents_globaux')
    ...
    try:
        ...
        with transaction.atomic():
            ...
            hopital.afficher_logo = request.POST.get('global_afficher_logo') == 'on'
            hopital.afficher_cachet = request.POST.get('global_afficher_cachet') == 'on'
            hopital.afficher_cc = request.POST.get('global_afficher_cc') == 'on'
            hopital.afficher_ifu = request.POST.get('global_afficher_ifu') == 'on'
            hopital.afficher_rccm = request.POST.get('global_afficher_rccm') == 'on'
            hopital.afficher_telephone = request.POST.get('global_afficher_telephone') == 'on'
            hopital.afficher_republique = request.POST.get('global_afficher_republique') == 'on'
            hopital.afficher_devise = request.POST.get('global_afficher_devise') == 'on'
            hopital.afficher_direction = request.POST.get('global_afficher_direction') == 'on'
            hopital.afficher_sous_direction = request.POST.get('global_afficher_sous_direction') == 'on'
            hopital.afficher_service = request.POST.get('global_afficher_service') == 'on'
