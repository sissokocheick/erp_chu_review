...
MENU_ITEMS_META = {
    ...
    # Permissions Patrimoine détaillées (pour la page Rôles)
    'menu_pat_fiche_detail': {'label': 'Fiches Détaillées', 'icon': 'fa-file-alt', 'color': '#1c5b96'},
    ...
    'menu_pat_contrat_detail': {'label': 'Détail Contrats', 'icon': 'fa-file-contract', 'color': '#17a2b8'},
    ...
    'menu_pat_intervention_detail': {'label': 'Détail Interventions', 'icon': 'fa-clipboard-list', 'color': '#20c997'},
    'menu_pat_signaler_panne': {'label': 'Signaler Panne', 'icon': 'fa-exclamation-triangle', 'color': '#dc3545'},
    'menu_pat_creer_intervention': {'label': 'Créer Intervention', 'icon': 'fa-plus-circle', 'color': '#28a745'},
    ...
    'menu_pat_schema_maintenance': {'label': 'Schémas Maintenance', 'icon': 'fa-project-diagram', 'color': '#1c5b96'},
    ...
    'menu_pat_bon_sortie_reparation': {'label': 'Bon Sortie Réparation', 'icon': 'fa-dolly', 'color': '#fd7e14'},
    'menu_pat_campagnes_inventaire': {'label': 'Campagnes Inventaire', 'icon': 'fa-calendar-check', 'color': '#28a745'},
    'menu_pat_detail_campagne': {'label': 'Détail Campagne', 'icon': 'fa-chart-pie', 'color': '#17a2b8'},
    'menu_pat_reconciliation': {'label': 'Réconciliation Inventaire', 'icon': 'fa-balance-scale', 'color': '#6f42c1'},
