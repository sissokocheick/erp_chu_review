...
MENU_ITEMS_META = {
    ...
    'menu_retours_fournisseurs': {'icon': 'fa-truck-ramp-box',  'color': '#ff9e9e', 'label': 'Retours Fournisseurs'},
    ...
    # Projets
    'menu_projets':              {'icon': 'fa-project-diagram', 'color': '#6f42c1', 'label': 'Suivi de Projets'},
    ...
    'menu_pat_parametres':       {'icon': 'fa-sliders-h',       'color': '#ffda6a', 'label': 'Paramètres Patrimoine'},
...
ROLE_ARCHITECTURE_MENU = OrderedDict([
    ...
    ('🏪 MOUVEMENTS DE STOCK', ['menu_entrees', 'menu_sorties', 'menu_sorties_hors_stock', 'menu_retours_services', 'menu_retours_fournisseurs', 'menu_transferts', 'menu_livraisons', 'menu_reception_commande']),
    ('📦 GESTION DES STOCKS', ['menu_stock', 'menu_destructions', 'menu_ajustements', 'menu_inventaires', 'menu_lots', 'menu_peremptions', 'menu_historique']),
    ('🛍️ ACHATS & CATALOGUE', ['menu_commandes', 'menu_articles', 'menu_familles']),
    ('🏗️ PROJETS', ['menu_projets']),
    ('🏢 PATRIMOINE & SAV', ['menu_pat_tickets', 'menu_pat_tech', 'menu_pat_dispatch', 'menu_pat_historique', 'menu_pat_registre', 'menu_pat_fiche_detail', 'menu_pat_modifier_immo', 'menu_pat_mouvements', 'menu_pat_eclatement', 'menu_pat_immatriculation', 'menu_pat_qr_codes', 'menu_pat_export_registre', 'menu_pat_sas', 'menu_pat_contrats', 'menu_pat_contrat_detail', 'menu_pat_assigner_equipements', 'menu_pat_import', 'menu_pat_inventaire', 'menu_pat_campagnes_inventaire', 'menu_pat_detail_campagne', 'menu_pat_reconciliation', 'menu_pat_audit_scan', 'menu_pat_fiche_comptage', 'menu_pat_interventions', 'menu_pat_intervention_detail', 'menu_pat_signaler_panne', 'menu_pat_creer_intervention', 'menu_pat_valider_intervention', 'menu_pat_portail_prestataire', 'menu_pat_schema_maintenance', 'menu_pat_types_equipements', 'menu_pat_mes_tickets', 'menu_pat_suivi_ticket', 'menu_pat_bon_sortie_reparation', 'menu_pat_rebuts', 'menu_pat_pertes', 'menu_pat_vehicules', 'menu_pat_vehicules_demander', 'menu_pat_vehicules_valider', 'menu_pat_vehicules_missions', 'menu_pat_vehicules_interventions', 'menu_pat_salles', 'menu_pat_salles_demander', 'menu_pat_salles_valider', 'menu_pat_salles_calendrier', 'menu_pat_salles_reservations']),
    ('📈 RAPPORTS & EXPORTS', ['menu_rapports', 'menu_rapport_conso_service', 'menu_stats_demandes', 'menu_stats_sondages', 'menu_stats_satisfaction']),
    ('⚙️ PARAMÈTRES', OrderedDict([
        ('Général', ['menu_parametres']),
        ('Administratifs', ['menu_param_admin', 'menu_services', 'menu_specialites', 'menu_fonctions']),
        ('Logistique', ['menu_param_logistique', 'menu_magasins', 'menu_fournisseurs', 'menu_motifs_annulation', 'menu_beneficiaires']),
        ('Patrimoine', ['menu_pat_parametres']),
