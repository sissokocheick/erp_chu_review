...
def valider_mot_de_passe(password, contexte='default'):
    ...
    # Plafond : set_password lève ValueError au-delà de 4096 octets —
    # refuser proprement ici plutôt que de provoquer une erreur 500.
    if len(password) > 128:
        erreurs.append("Au maximum 128 caractères")
