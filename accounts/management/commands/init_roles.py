...
ROLE_DEFS = {
    ...
    'Directeur': {
        'description': 'Direction, audit, rapports',
        'perms': [
            'menu_accueil', 'menu_dashboard',
    ...
    'Technicien SAV': {
        ...
        'perms': [
            'menu_accueil', 'menu_dashboard',
            'menu_pat_tickets', 'menu_pat_mes_tickets',
            'menu_pat_tech', 'menu_pat_dispatch',
            'menu_pat_interventions', 'menu_pat_intervention_detail',
            'menu_pat_signaler_panne', 'menu_pat_creer_intervention',
    ...
    'Gestionnaire Patrimoine': {
        'description': 'Registre, contrats, inventaires, parametres',
        'perms': ['menu_pat_'],
    },
    'Comptable': {
